...
public class CustomerQueueManager {
	...
	private static ConcurrentLinkedQueue<CustomerThread> tQueue = new ConcurrentLinkedQueue<CustomerThread>();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		CustomerThread customer = tQueue.poll();
			...
			customer.start();
			//join method will not allow Thread 2 to start its work untill Thread 1 finished its work and so on.
			customer.join();
		}
